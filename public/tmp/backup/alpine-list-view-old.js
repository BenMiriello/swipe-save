...
window.alpineListView = {
   ...
   */
  init() {
    console.log('alpineListView.init() called');
    console.log('Alpine available:', !!window.Alpine);
    console.log('appState store available:', !!Alpine?.store('appState'));
  ...
  createListViewComponent() {
    ...
    container.innerHTML = `
      ...
      <div class="comfyui-section" x-data="{ isFileListExpanded: $store.listView.fileListOpen }">
